...
function loadData() {
    ...
    request.open('GET', 'http://api.openweathermap.org/data/2.5/forecast/daily/?q=Salt+Lake+City,us&units=imperial&cnt=5&appid=846d3b48355b6e95813bed8fb29f0fb3', true);
...
function loadComplete(evt) {
    ...
    document.getElementById("minTemp2").innerHTML = weatherData.list[1].temp.max+"&deg;";
    document.getElementById("maxTemp2").innerHTML = weatherData.list[1].temp.min+"&deg;";
    ...
    document.getElementById("minTemp3").innerHTML = weatherData.list[2].temp.max+"&deg;";
    document.getElementById("maxTemp3").innerHTML = weatherData.list[2].temp.min+"&deg;";
    ...
    document.getElementById("minTemp4").innerHTML = weatherData.list[3].temp.max+"&deg;";
    document.getElementById("maxTemp4").innerHTML = weatherData.list[3].temp.min+"&deg;";
    ...
    document.getElementById("minTemp5").innerHTML = weatherData.list[4].temp.max+"&deg;";
    document.getElementById("maxTemp5").innerHTML = weatherData.list[4].temp.min+"&deg;";
}
